    ...
    <section className="px-6 py-20  bg-[#0a192f] text-[#ccd6f6]" id="projects">
      <div className="bg-[#112240] shadow-md rounded-xl p-6 max-w-3xl leading-relaxed text-lg">
        ...
        <p className="mb-4 text-[#8892b0]">
          <span className="text-[#ccd6f6] font-medium">균형마당</span>은
          중장년층의 균형 감각 향상을 위한{" "}
          <span className="text-[#ccd6f6]">AI 기반 헬스케어 앱</span>입니다.
          사용자가 스마트폰을 귀에 댄 채{" "}
          <span className="text-[#ccd6f6]">20초간 센서 데이터를 측정</span>하면,
          이를 바탕으로 개인 맞춤형 운동을 추천합니다.
        </p>

        <p className="mb-4 text-[#8892b0]">
          프론트엔드는 <span className="text-[#ccd6f6]">Expo</span> 기반의{" "}
          <span className="text-[#ccd6f6]">React Native</span>로 구현하여 다양한
          모바일 환경에서 안정적인 실행을 보장하며, 백엔드는{" "}
          <span className="text-[#ccd6f6]">Spring Boot</span>와{" "}
          <span className="text-[#ccd6f6]">FastAPI</span>로 구성되어 각각 사용자
          데이터 관리와 AI 분석 기능을 담당합니다.
        </p>

        <p className="mb-4 text-[#8892b0]">
          <span className="text-[#ccd6f6]">OpenAI API</span>를 활용한 LLM 기반
          피드백 기능과, <span className="text-[#ccd6f6]">scikit-learn</span>{" "}
          기반의 머신러닝 추천 모델을 연동해, 사용자 상태에 최적화된 운동
          가이드를 제공합니다.
        </p>

        <p className="mb-4 text-[#8892b0]">
          전체 백엔드 시스템은 <span className="text-[#ccd6f6]">Render</span>를
          이용해 클라우드에 배포하였으며, 클라이언트와 AI 서버 간의 통신은
          <span className="text-[#ccd6f6]">RESTful API 구조</span>로 구현해 높은
          안정성과 확장성을 확보했습니다.
        </p>
